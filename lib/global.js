...
var Global = {
    ...
    mark_challenge_completed: function(challenge, callback) {
        Parse.Cloud.run('mark_challenge_completed', { challenge_id: challenge.id }, {
            success: function (response) {
                p('success mark_challenge_completed');
                Global.updateCompleted(response.challenges_completed);
                if (callback) {
                    callback()
                }
            },
            error: function (error) {
                p('error mark_challenge_completed');
                //TODO - user message  here
            }
        });
    },
    ...
    // updates the completed challenge in the client object
    updateCompleted(challenges_completed){
        tc.user.challenges_completed = challenges_completed
    },
